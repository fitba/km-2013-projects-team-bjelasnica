<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="FITKMS.QA.Edit" %>
                        ...
                        <div class="control-group">
                            <div class="controls controls-row">
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
                                    <ContentTemplate>
                                        <asp:DropDownList ID="ddOblast" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddOblast_SelectedIndexChanged"></asp:DropDownList>
