            ...
            <div class="widget no-margin">
                <div class="row-fluid">
                    <div class="widget-body">
                        ...
                        <asp:Button ID="loadTagsSubmit" runat="server" Style="display: none" OnClick="loadTagsSubmit_Click" />
                        <!-- Modal -->
                        <div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-footer">
                                <asp:Button ID="saveTagsSubmit" runat="server" CssClass="btn btn-info" Text="Sačuvaj" Height="30px" OnClick="saveTagsSubmit_Click" />
                            </div>
                        </div>
                        <!-- End Modal -->
